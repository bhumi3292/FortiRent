                ...
                <form onSubmit={formik.handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex justify-between items-center pt-6 mt-2 border-t border-gray-100">
                        ...
                        {step < 3 ? (
                            ...
                            <button type="submit" disabled={isSubmitting} className="px-8 py-2.5 rounded-xl bg-secondary text-white font-bold hover:bg-[#e09252] flex items-center gap-2 shadow-lg shadow-secondary/20 transition-all disabled:opacity-70">
