            ...
            <section className="relative py-20 bg-background overflow-hidden mt-16">
                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-secondary font-bold text-sm mb-6 border border-blue-100">
                        <Home size={16} /> Welcome to FortiRent
                    </div>
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-heading">Redefining Rental Trust</h1>
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                        We're on a mission to make finding and renting the perfect home as simple and stress-free as possible.
                        FortiRent bridges the gap between landlords and tenants with verified listings and secure processes.
                    </p>
                    <Link to="/property">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                                At FortiRent, we believe everyone deserves a place they can call home without the fear of scams or hidden issues.
            ...
            <section className="py-20 bg-primary text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                        Join thousands of satisfied customers who found their perfect rental through FortiRent.
                    </p>
