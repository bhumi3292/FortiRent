...
export default function ContactPage() {
    ...
    const supportTopics = [
        ...
        { title: "Property Listing", description: "Questions about listing your property", icon: MapPin },
            ...
            <section className="relative py-20 bg-primary/5 mt-16 overflow-hidden">
                <div className="container mx-auto px-4 text-center z-10 relative">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Have questions about FortiRent? We're here to help you find your way home.
                    </p>
                </div>
            </section>
